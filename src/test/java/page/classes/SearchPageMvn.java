...
public class SearchPageMvn {
	public static WebElement element = null;
	private static final Logger log = LogManager.getLogger(SearchPageMvn.class.getName());
...
//		element.click();
	...
	public static void selectFlightAdults(WebDriver driver, String flightAdults) {
		...
		//div[@id='traveler-selector-hp-flight']//ul[@class='menu-bar-inner']/li/button[@type='button']
		Select options = new Select(driver.findElement(By.xpath("//div[@id='traveler-selector-hp-flight']//ul[@class='menu-bar-inner']/li/button[@type='button']")));
